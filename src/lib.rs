...
extern "C" {
    ...
    -> *mut ();
    fn __builtin___memmove_chk(_: *mut (), _: *const (), _: u64, _: u64)
    -> *mut ();
    fn malloc(__size: u64)
    -> *mut ();
    fn __builtin___strncpy_chk(_: *mut i8, _: *const i8, _: u64, _: u64)
    -> *mut i8;
    ...
    -> u64;
    fn __builtin___snprintf_chk(_: *mut i8, _: u64, _: i32, _: u64,
    _: *const i8, ...)
    -> i32;
